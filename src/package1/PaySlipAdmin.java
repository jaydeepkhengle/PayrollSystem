...
public class PaySlipAdmin extends JInternalFrame {
	/**
	 * 
	 */
	...
	public static JTextField lblName;
	private JTextField txtSalary_1;
	private JLabel lblNewLabel_1;
	private JTextField txtDate;
	private JTextField textField_19;
	public static JTextField  lblDesignation, lblPlace, lblDept,  lblBnk, lblBankNum;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PaySlipAdmin frame = new PaySlipAdmin();
	...
	public PaySlipAdmin() {
		...
		btnClose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PanelMonthlySalary.panelPaySlip.setVisible(false);
				PanelMonthlySalary.btnGenerateSalary.setVisible(true);
			}
		});
