...
public class PanelMonthlySalary extends JPanel {
	...
	public PanelMonthlySalary() {
		...
		btnGenerateSalary.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PaySlipAdmin paySlip2 = new PaySlipAdmin();
				...
				System.out.println(PanelSalary.txtEmployeeId.getText() + "-------------------");
				ResultSet result = mySQl.getSalary(PanelSalary.txtEmployeeId.getText());
				try {
					while(result.next()) {
						...
						PaySlipAdmin.txtBasicSalary.setText(Integer.toString(basicSalary));
						PaySlipAdmin.txtDA.setText(Integer.toString(DA));
						PaySlipAdmin.txtHRA.setText(Integer.toString(HRA));
						PaySlipAdmin.txtMed.setText(Integer.toString(med));
						PaySlipAdmin.txtTravel.setText(Integer.toString(travel));
						PaySlipAdmin.txtTax.setText(tax + " Rs/-");
						PaySlipAdmin.txtMedclaim.setText(med+ " Rs/-");
						PaySlipAdmin.txtGrossSalary.setText(Integer.toString(grossSalary)+ " Rs/-");
						PaySlipAdmin.txtDeduction.setText(Integer.toString(totalDeduction) + " Rs/-");
						PaySlipAdmin.txtUnpaidLeaves.setText(unpaidDeduction+ " Rs/-");
						PaySlipAdmin.txtNetSalary.setText(((result.getInt("Net_Salary")/12)-totalDeduction) + " Rs/-");
						PaySlipAdmin.lblName.setText(result.getString("name"));
						PaySlipAdmin.lblName.setBorder(null);
						PaySlipAdmin.lblName.revalidate();
						PaySlipAdmin.lblName.repaint();
						PaySlipAdmin.lblDesignation.setText(result.getString("Designation"));
						PaySlipAdmin.lblDesignation.revalidate();
						PaySlipAdmin.lblDesignation.repaint();
						PaySlipAdmin.lblPlace.setText(result.getString("city"));
						PaySlipAdmin.lblPlace.revalidate();
						PaySlipAdmin.lblPlace.repaint();
						PaySlipAdmin.lblDept.setText(txtDepartment.getText());
						PaySlipAdmin.lblDept.revalidate();
						PaySlipAdmin.lblDept.repaint();
						PaySlipAdmin.lblBnk.setText(txtBankName.getText());
						PaySlipAdmin.lblBnk.revalidate();
						PaySlipAdmin.lblBnk.repaint();
						PaySlipAdmin.lblBankNum.setText("xxxxxXXXX");
						PaySlipAdmin.lblBankNum.revalidate();
						PaySlipAdmin.lblBankNum.repaint();
						revalidate();
						repaint();
		...
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PanelSalary.GetDataNewButton.setVisible(true);
				PanelSalary.btnBack.setVisible(true);
				PanelSalary.btnClear.setVisible(true);
				PanelSalary.btnSave.setVisible(true);
				PanelSalary.btnMonthlySalary.setVisible(true);
				PanelSalary.dateChooser.setVisible(true);
				setVisible(false);
			}
		});
